...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .addServer('https://api-pmt.herokuapp.com/v1', 'Main (production) Server')
    ...
    .setDescription('A Role-based Project Management API backed by Authorizations provided by the CASL Authorization Library')
    .setVersion('1.0')
